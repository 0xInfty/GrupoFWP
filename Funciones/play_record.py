...
def play_record(
    ...
    dT = 1, # duración en seg de un buffer
    dt = 0.005, # duración en seg de cada frame del buffer
    ch = 1, # cantidad de canales
    sr = 44000, # sampling rate de grabación
    freq = 440, # frecuencia de tono en modo 'freq'
